...
impl DiagnosticModule for EventLogModule {
    ...
    async fn scan(&self, progress_tx: Option<Sender<ModuleProgress>>) -> Result<Vec<Issue>, String> {
        ...
        Self::send_progress(&progress_tx, 50, "Scanne System-Ereignisprotokolle der letzten 24h (wevtutil)...", Some("wevtutil qe System...")).await;

        // Query last 10 critical / error events from System log
        ...
        Self::send_progress(&progress_tx, 80, "Prüfe auf WHEA-Hardwarefehler...", Some("Filterung nach WHEA-Logger...")).await;
